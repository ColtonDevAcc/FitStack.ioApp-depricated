...
//   final Recovery_View widget;
//   MyPainter(this._context, this.widget);

//   @override
//   void paint(Canvas canvas, Size size) {
//     var _canvas = TouchyCanvas(_context, canvas);

//     final muscleListProvider = Provider<List<List>>((ref) {
//       final paths = [
//         const [
...
//     for (var path in muscleListProvider) {
//       //draw shape paths
//       Path _path = parseSvgPath(path[0]);
...
//       _canvas.drawPath(
//         _path.transform(matrix4.storage),
//         Paint()
//           ..color = path[1]
//           ..strokeWidth = 4.0,
//         onTapDown: (e) {
//           var indexOfWidget = widget.paths.indexWhere((element) => element[0] == path[0]);

//           widget.paths[indexOfWidget] = [path[0], Colors.blue];

//           print(widget.paths[indexOfWidget]);
//         },
//       );
//     }
//   }
