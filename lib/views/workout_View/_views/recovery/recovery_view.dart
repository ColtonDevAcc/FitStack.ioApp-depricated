...
class Recovery_View extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Listener(
      ...
      child: CustomPaint(
        painter: WorldMapPainter(notifier, context),
...
class WorldMapPainter extends CustomPainter {
  ...
  WorldMapPainter(this._notifier, this.context) : super(repaint: _notifier);
...
m 173.64995,526.69 c 4,-4 7.94,-0.5 10.92,10.91 Q 210.56992,689.43 114.56999,735.07 100.44,741.76 108.57,724.65 c 13.38999,-26.3 21.82998,-56.06 25.29998,-89.8 3,-37.21 15.87999,-73.43 39.68997,-108.16 z
...
m 567.3,1173.1 c -0.5,-14.38 0.49,-33.73 0.49,-50.6 0.5,-4.47 3,-7 7.94,-7 0,0 14.39,-1 42.67,-2.48 6,1.49 7.44,5.46 5.46,12.4 -7,20.84 -23.82,39.7 -49.12,50.61 q -6,3 -7.44,-3 z'''
  ...
  final _shapes = [
    Shape(_data[0], 'front_model_trace', Colors.grey),
    Shape(_data[1], 'front_left_hand', Colors.grey),
    Shape(_data[2], 'front_left_forearm_outter', Colors.green),
    Shape(_data[3], 'front_left_forearm_inner', Colors.lightGreen),
    Shape(_data[4], 'front_left_bicept', Colors.orange),
    Shape(_data[5], 'front_left_shoulder', Colors.red),
    Shape(_data[6], 'front_left_trapazoid', Colors.indigo),
    Shape(_data[7], 'front_left_chest', Colors.white),
    Shape(_data[8], 'front_left_obliues', Colors.white),
    Shape(_data[9], 'front_left_quad_outter', Colors.white),
    Shape(_data[10], 'front_left_quad_inner', Colors.white),
    Shape(_data[11], 'front_left_calve', Colors.white),
    Shape(_data[12], 'front_pelvic', Colors.white),
    Shape(_data[13], 'front_left_top_abb', Colors.white),
    Shape(_data[14], 'front_left_middle_abb', Colors.white),
    Shape(_data[15], 'front_left_bottom_abb', Colors.white),
    Shape(_data[16], 'front_right_hand', Colors.white),
    Shape(_data[17], 'front_right_forearm_outter', Colors.white),
    Shape(_data[18], 'front_right_forearm_inner', Colors.white),
    Shape(_data[19], 'front_right_bicept', Colors.white),
    Shape(_data[20], 'front_right_shoulder', Colors.white),
    Shape(_data[21], 'front_right_trapazoid', Colors.white),
    Shape(_data[22], 'front_right_chest', Colors.white),
    Shape(_data[23], 'front_right_obliues', Colors.white),
    Shape(_data[24], 'front_right_quad_outter', Colors.white),
    Shape(_data[25], 'front_right_quad_inner', Colors.white),
    Shape(_data[26], 'front_right_calve', Colors.white),
    Shape(_data[27], 'front_right_top_abb', Colors.white),
    Shape(_data[28], 'front_right_middle_abb', Colors.white),
    // Shape(_data[29], 'front_right_bottom_abb', Colors.white),
  ];
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (size != _size) {
      _size = size;
      final fs = applyBoxFit(BoxFit.contain, Size(1050, 2000), size);
    ...
    canvas
      ...
      ..drawColor(Apptheme.mainBackgroundColor, BlendMode.src);
    var selectedShape;
    for (var shape in _shapes) {
      final path = shape._transformedPath;
      final selected = path.contains(_notifier.value);
      _paint
        ..color = selected ? Colors.red : shape._color
