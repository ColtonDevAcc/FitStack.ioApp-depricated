    ...
    return SafeArea(
      child: Padding(
        ...
        child: Column(
          children: [
            SizedBox(height: 20),
            Text('Nutrition', textScaleFactor: 1.3, style: TextStyle(color: Apptheme.mainTextColor)),
            SizedBox(height: 20),
            TextFormField(
            ...
            Row(
              ...
              children: [
                Expanded(child: userStatisticsTab(icon: LineIcons.burn, detailsString: 'Calories', value: 3200)),
                Expanded(child: userStatisticsTab(icon: LineIcons.drumstickWithBiteTakenOut, detailsString: 'Vitamin D', value: 30)),
              ],
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Expanded(child: userStatisticsTab(icon: LineIcons.fish, detailsString: 'Vitamin A', value: 120)),
                Expanded(child: userStatisticsTab(icon: LineIcons.seedling, detailsString: 'Vitamin E', value: 120)),
              ],
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Expanded(child: userStatisticsTab(icon: LineIcons.fruitApple, detailsString: 'Vitamin C', value: 120)),
                Expanded(child: userStatisticsTab(icon: Icons.local_fire_department, detailsString: 'Protein', value: 120)),
              ],
            ),
            SizedBox(height: 20),
            Text('Recents', textScaleFactor: 1.3, style: TextStyle(color: Apptheme.mainTextColor)),
            SizedBox(height: 20),
            Expanded(
                child: ListView(
              children: [
